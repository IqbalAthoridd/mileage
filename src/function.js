module.exports = {
    hitungJarak: (jamA, jamB) => {
        ...
        //di ubah menjadi detik
        menit = jam * 60 - menit
        detik = menit * 60 - detik

        for (i = 1; i <= detik; i++) {
            jarak += kecepatan //kecepatan bertambah per/detik
            if (i === 300) { //jika sudah 5 menit kecepatan +2
                recentDetik = i
                kecepatan += 2

            } else if (i === recentDetik + 600) {//setiap 10 menit kecepatan +1
                recentDetik = i
                kecepatan += 1
